...
[![Latest Release](https://img.shields.io/badge/version-1.0.20-blue.svg)](https://github.com/godrift-ai/drift-releases/releases/latest)
...
**Current Version:** `1.0.20` ([View Release Notes](https://github.com/godrift-ai/drift-releases/releases/latest))

Download the `.deb` package directly:
- [drift-cli_1.0.20_amd64.deb](https://github.com/godrift-ai/drift-releases/releases/latest)
