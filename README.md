...
[![Latest Release](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/drift-tech/drift-releases/releases/latest)
...
**Current Version:** `1.0.0` ([View Release Notes](https://github.com/drift-tech/drift-releases/releases/latest))

Download the `.deb` package directly:
- [drift-cli_1.0.0_amd64.deb](https://github.com/drift-tech/drift-releases/releases/latest)
